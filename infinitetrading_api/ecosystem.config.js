...
module.exports = {
  apps: [
    ...
    {
      name: "strategy-crossoverv4",
      script: "Rscript",
      args: "strategies/crossOverV4.R",
      cwd: "/home/ubuntu/infinitetrading/src",
      instances: 1,
      exec_mode: "fork",
      watch: false,
      ...
      error_file: "logs/strategy-crossoverv4-error.log",
      out_file: "logs/strategy-crossoverv4-out.log",
      log_date_format: "YYYY-MM-DD HH:mm:ss Z",
      merge_logs: true,
      max_size: "50M",
      retain: 10,
    ...
    {
      name: "strategy-btc-yield-base",
      script: "Rscript",
      args: "strategies/btc_yield_base.R",
      cwd: "/home/ubuntu/infinitetrading/src",
      instances: 1,
      exec_mode: "fork",
      watch: false,
      ...
      error_file: "logs/strategy-btc-yield-base-error.log",
      out_file: "logs/strategy-btc-yield-base-out.log",
      log_date_format: "YYYY-MM-DD HH:mm:ss Z",
      merge_logs: true,
      max_size: "50M",
      retain: 10,
