...
function waitForSuccess(tx_1, provider_1) {
    return __awaiter(this, arguments, void 0, function (tx, provider, timeoutMs, confirmations) {
        var timer, receipt;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, receipt]; // includes effectiveGasPrice, gasUsed, etc.
            }
        });
    });
}
