...
network, provider, providerApiKey, contractAddress // Pool OR PoolAddressesProvider
    ...
    return __awaiter(this, void 0, void 0, function () {
        var rpcProvider, code, poolAddress, addressesProvider, resolved, _a, pool, reserveData, aTokenAddress, aToken, underlying, _b, raw, decimals, suppliedAmount;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    rpcProvider = new ethers_1.ethers.providers.JsonRpcProvider((0, rpc_1.rpc)(network, provider, providerApiKey));
                ...
                case 4:
                    ...
                    return [3 /*break*/, 5];
                case 5:
                    pool = new ethers_1.ethers.Contract(poolAddress, IPoolV3Abi, rpcProvider);
                    return [4 /*yield*/, pool.getReserveData(asset)];
                case 6:
                    reserveData = _c.sent();
                    aTokenAddress = reserveData.aTokenAddress;
                    if (!ethers_1.ethers.utils.isAddress(aTokenAddress) || aTokenAddress === ethers_1.ethers.constants.AddressZero) {
                ...
                case 7:
                    _b = _c.sent(), raw = _b[0], decimals = _b[1];
                    suppliedAmount = ethers_1.ethers.utils.formatUnits(raw, decimals);
                    return [2 /*return*/, { suppliedAmount: suppliedAmount }];
            }
        });
    });
}
...
network, provider, providerApiKey, contractAddress // Pool OR PoolAddressesProvider
    ...
    return __awaiter(this, void 0, void 0, function () {
        var rpcProvider, code, poolAddress, addressesProvider, resolved, _a, pool, reserveData, _b, stableDebtTokenAddress, variableDebtTokenAddress, stableDebt, variableDebt, underlying, _c, sBal, vBal, decimals, total, borrowedAmount;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 6:
                    ...
                    return [4 /*yield*/, pool.getReserveData(asset)];
                case 7:
                    _b = (_d.sent()), stableDebtTokenAddress = _b.stableDebtTokenAddress, variableDebtTokenAddress = _b.variableDebtTokenAddress;
                ...
                case 8:
                    _c = _d.sent(), sBal = _c[0], vBal = _c[1], decimals = _c[2];
                    total = ethers_1.BigNumber.from(sBal).add(vBal);
                    borrowedAmount = ethers_1.ethers.utils.formatUnits(total, decimals);
                    return [2 /*return*/, { borrowedAmount: borrowedAmount }];
            }
        });
    });
}
