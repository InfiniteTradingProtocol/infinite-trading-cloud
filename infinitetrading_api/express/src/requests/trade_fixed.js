    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 6:
                ...
                return [4 /*yield*/, pool.approve(dApp, req.body.asset, v2_sdk_1.ethers.constants.MaxUint256, txOptions, { estimateGas: true })];
            case 7:
    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 7:
                ...
                estimatedGas = void 0;
                return [4 /*yield*/, pool.tradeUniswapV3(assetA, assetB, tradeAmount, feeAmount, +slippage, txOptions, { estimateGas: true })];
            case 8:
            ...
            case 11:
                ...
                return [4 /*yield*/, pool.trade(v2_sdk_1.Dapp.TOROS, assetA, assetB, tradeAmount, +slippage, txOptions, { estimateGas: true })];
            case 12:
                estGas1 = _e.sent();
            ...
            case 15:
                ...
                return [4 /*yield*/, pool.completeTorosWithdrawal(assetB, +slippage, txOptions, { estimateGas: true })];
            case 16:
                estGas2 = _e.sent();
            ...
            case 17:
                txOptions2 = _e.sent();
                return [4 /*yield*/, pool.completeTorosWithdrawal(assetB, +slippage, txOptions2)];
            case 18:
                tx2 = _e.sent();
            ...
            case 21:
                ...
                return [4 /*yield*/, pool.trade(dApp, assetA, assetB, tradeAmount, +slippage, txOptions, { estimateGas: true })];
            case 22:
                estimatedGas = _e.sent();
                _e.label = 23;
            case 23:
