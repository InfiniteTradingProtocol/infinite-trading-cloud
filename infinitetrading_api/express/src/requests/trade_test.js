...
var walletLocks = new Map();
function getLockForKey(apiKey) {
    if (!walletLocks.has(apiKey))
        walletLocks.set(apiKey, new async_mutex_1.Mutex());
...
tradeRouter.post("/approve", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var network, poolAddress, manager, provider, key, apiKey, pool, lock, dHedge, txOptions, dApp, platform, estimatedGas, txOptions2, tx, receipt, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
tradeRouter.post("/approve2", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var network_1, poolAddress, provider_1, key_1, apiKey, manager, dHedge, pool_2, apiKey_1, txOptions, dApp_1, platform, estimatedGas, txOptions2_1, lock, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 10, , 11]);
                network_1 = req.query.network;
                poolAddress = req.query.pool;
                provider_1 = req.query.provider || 'alchemy';
                key_1 = req.query.key;
                apiKey = req.query.apiKey;
                manager = null;
                if (req.query.manager)
                ...
                return [4 /*yield*/, (0, dhedge_1.dhedgev2)(network_1, apiKey_1, provider_1, key_1)];
            case 1:
                dHedge = _a.sent();
                return [4 /*yield*/, dHedge.loadPool(poolAddress)];
            case 2:
                pool_2 = _a.sent();
                return [3 /*break*/, 5];
            case 3: return [4 /*yield*/, (0, dhedge_1.dhedge)(network_1, manager).loadPool(poolAddress)];
            case 4:
                pool_2 = _a.sent();
                _a.label = 5;
            case 5: return [4 /*yield*/, (0, txOptions_1.getTxOptions)(pool_2.network, provider_1, key_1)];
            case 6:
                txOptions = _a.sent();
                if (req.query.platform) {
                    platform = req.query.platform.toLowerCase();
                    if (platform == "uniswapv3")
                        ...
                        dApp_1 = v2_sdk_1.Dapp.ONEINCH;
                    else if (platform == "1inch")
                        dApp_1 = v2_sdk_1.Dapp.ONEINCH;
                    else if (platform == "aave" || platform == "aavev3")
                        dApp_1 = v2_sdk_1.Dapp.AAVEV3;
                    else
                        dApp_1 = req.query.platform;
                }
                else
                    throw "platform parameter missing";
                return [4 /*yield*/, pool_2.approve(dApp_1, req.body.asset, v2_sdk_1.ethers.constants.MaxUint256, txOptions, true)];
            case 7:
                estimatedGas = _a.sent();
                console.log("estimated gas for approve:");
                console.log(estimatedGas);
                return [4 /*yield*/, (0, txFees_1.txFees)(network_1, provider_1, key_1, estimatedGas)];
            case 8:
                txOptions2_1 = _a.sent();
                lock = getLockForKey(key_1);
                return [4 /*yield*/, lock.runExclusive(function () { return __awaiter(void 0, void 0, void 0, function () {
                        var tx, receipt, apiKey_2;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, pool_2.approve(dApp_1, req.body.asset, MAX_ALLOWANCE, txOptions2_1)];
                                case 1:
                                    tx = _a.sent();
                                    console.log(tx);
                                    return [4 /*yield*/, tx.wait()];
                                case 2:
                                    receipt = _a.sent();
                                    console.log('Transaction mined:', receipt);
                                    if (!req.query.apiKey) return [3 /*break*/, 4];
                                    console.log("Sending API payment");
                                    apiKey_2 = req.query.apiKey;
                                    return [4 /*yield*/, (0, txFees_1.apiPayment)(network_1, apiKey_2, tx, provider_1, key_1, null)];
                                case 3:
                                    _a.sent();
                                    _a.label = 4;
                                case 4:
...
tradeRouter.get("/trade", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var network, withdrawal, assetA, assetB, manager, dHedge, slippage, poolAddress, feeAmount, pool, provider, key, apiKey, tradeAmount, composition, balance, share, amount, txOptions, tx, dApp, platform, txHashes, paymentTx, estimatedGas, txOptions2, estimatedGas, estGas1, txOptions1, tx1, r1, estGas2, txOptions2, tx2, txOptions2, err_3, message;
    var _a, _b, _c, _d;
    return __generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 29:
                err_3 = _e.sent();
                console.error("Trade error:", err_3);
                message = (err_3 instanceof Error) ? err_3.message : JSON.stringify(err_3);
