...
pools           = c("0xa3ff483dcc9791d69d876981b1112269a6ed062d","0x86729853f9cca4c1ec0c160792f36e1bf97d58c3","0x4ce9628fae744c86b3e5435d6777aa4ff2cd15b6")
pairs           = c("MORPHO-USDC","SNX-USDC","AERO-USDC")
candles_pairs   = c("MORPHO-USD","SNX-USD","AERO-USD")
