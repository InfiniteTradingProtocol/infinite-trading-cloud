...
networks        = c("base","optimism","base","optimism","base")
protocols       = rep("dhedge",5)
pools           = c("0xa3ff483dcc9791d69d876981b1112269a6ed062d","0x86729853f9cca4c1ec0c160792f36e1bf97d58c3","0x4ce9628fae744c86b3e5435d6777aa4ff2cd15b6","0x9b1a83432996e4e075dd24d4ed7288a2c4ca730a","0xd92989c7e93a46fc10e6f49b796b529e2b076e3d")
pairs           = c("MORPHO-USDC","SNX-USDC","AERO-USDC","AAVE-USDC","cbBTC-USDC")
candles_pairs   = c("MORPHO-USD","SNX-USD","AERO-USD","AAVE-USD","cbBTC-USD")
timeframes	= c("6h","6h","6h","6h","6h")
slippages       = c(0.5,0.5,0.5,0.5,0.3)
shares          = c(100,100,100,100,100)
platforms       = c("odos","odos","odos","odos","odos")
max_usds        = c(5000,5000,5000,5000,10000)
