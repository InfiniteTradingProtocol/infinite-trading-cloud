...
exports.estimateGasLimitForTokenSwap = void 0;
 ...
 */
var provider = new ethers_1.ethers.providers.JsonRpcProvider('https://optimism-mainnet.infura.io/v3/d18c6d8db1024751a822f8b8b208737a');
var uniswapRouter = new ethers_1.ethers.Contract(uniswapRouterAddress, uniswapRouterABI, provider);
function estimateGasLimitForTokenSwap(dexRouterContract, tokenInAddress, tokenOutAddress, tokenInAmount, tokenOutAmount, userAddress) {
    return __awaiter(this, void 0, void 0, function () {
        var now, deadline, gasLimit;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    now = new Date;
                    deadline = now.setTime(now.getTime() + (30 * 60 * 1000));
                    return [4 /*yield*/, dexRouterContract.estimateGas.swapExactTokensForTokens(tokenInAmount, tokenOutAmount, [
                            tokenInAddress,
                            tokenOutAddress
                ...
                case 1:
                    ...
                    return [2 /*return*/, gasLimit.toString()];
            }
        });
    });
}
exports.estimateGasLimitForTokenSwap = estimateGasLimitForTokenSwap;
